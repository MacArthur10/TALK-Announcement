...
const OrderDetails = () => {
  ...
  return (
    <View style={styles.container}> 
          <Stack.Screen options={{ title: `${order.slug} FCFA` }} />
          <Text style={styles.item}>{order.slug}</Text>
          <Text style={styles.details}>{order.details}</Text>
          <View style={[styles.statusBadge, styles[`{order.status} statusBadge_FCFA`]]}>
        ...
        renderItem={({ item }) => (
          <View style={styles.orderItem}>
            ...
            <View style={styles.itemInfo}>
              ...
              <Text style={styles.itemPrice}>Price: {item.price} FCFA</Text>
            </View>
          </View>
        )}
      />
